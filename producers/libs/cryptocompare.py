...
URL_TOPEXCH = 'https://min-api.cryptocompare.com/data/top/exchanges?fsym={}&tsym={}&limit={}'
...
def get_topExchanges(coin, curr, limit=5):
    response = query_cryptocompare(URL_TOPEXCH.format(coin, curr, limit))
    if response: 
        return response
